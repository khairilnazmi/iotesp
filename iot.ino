...
int pinValue = param.asInt();
  if (pinValue == 1) {
    pixels.setPixelColor(0, 0xcc33cc);
    pixels.setPixelColor(1, 0xcc33cc);
    pixels.setPixelColor(2, 0xcc33cc);
    pixels.setPixelColor(3, 0xcc33cc);
    pixels.setPixelColor(4, 0xcc33cc);
    pixels.show();
    pixels.show();
    servo_5.write(0);
